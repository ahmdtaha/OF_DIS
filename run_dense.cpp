...
cv::Mat optical_flow(char* imgfile_ao,char* imgfile_bo)
{
    cout << "A " << imgfile_ao << endl;
    cout << "B " << imgfile_bo << endl;
#if (SELECTMODE==1)
    cout << "SELECTMODE = 1" << endl;
#elif(SELECTMODE==2)
    cout << "SELECTMODE = 2" << endl;
#else
    cout << "SELECTMODE = 3" << endl;
#endif
    ...
    incoltype = cv::IMREAD_COLOR;; //CV_LOAD_IMAGE_COLOR;
    rpyrtype = CV_32FC3;
    nochannels = 3;
#endif
